  ...
  return (
    <div className="about">
      ...
      <p className="aboutp">
        ...
        your eyes, or make a run to your nearest store. Don't like what we
        plated? Add your own food with the name, pic and description of your
        choosing. <br /> Zoom'd out? Got a crush? Tired of your coworkers? Add
        the foods that match your mood. Or, lettuce souprise you! <br />
        <p className="bread">
          Either way, It's All Gouda. Y'all bready for this?
        </p>
      </p>
    </div>
  );
